...
Route::get('/product/new_arrival', 'HomeController@product_new_arrival')->name('product.new_arrival');
Route::get('/product/{slug}', 'HomeController@product')->name('product');
Route::get('/category/{category_slug}', 'HomeController@listingByCategory')->name('products.category');
Route::get('/category/{category_id}/{subcategory_slug}', 'HomeController@listingBySubCategory')->name('products.subcategory');
Route::get('/category/seller/{category_slug}/{seller_user_id}', 'HomeController@listingByCategorySeller')->name('products.category.seller');
Route::get('/category/seller/{category_id}/{subcategory_slug}/{seller_user_id}', 'HomeController@listingBySubCategorySeller')->name('products.subcategory.seller');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    ...
    Route::get('/product/bulk/upload', 'HomeController@show_product_bulk_upload_form')->name('seller.product_bulk_upload.index');
...
Route::post('/search/compatibility/car_model', 'HomeController@compatibility_car_model')->name('search.compatibility.car_model');
Route::get('/search/product/compatibility', 'HomeController@listingByCompatibility')->name('search.product.compatibility');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/products/compatibility/car_model', 'ProductController@compatibility_car_model')->name('products.compatibility.car_model');
    ...
    Route::group(['prefix' => 'bulk-upload/download'], function() {
        ...
        Route::get('/photo', 'ProductBulkUploadController@pdf_download_photo')->name('pdf.download_photo');
        Route::get('/pdf', 'ProductBulkUploadController@pdf_download_pdf')->name('pdf.download_pdf');
        Route::get('/manufacturing_year', 'ProductBulkUploadController@pdf_download_manufacturing_year')->name('pdf.download_manufacturing_year');
        Route::get('/manufacturer', 'ProductBulkUploadController@pdf_download_manufacturer')->name('pdf.download_manufacturer');
        Route::get('/car_model', 'ProductBulkUploadController@pdf_download_car_model')->name('pdf.download_car_model');
    });
...
Route::get('/product-inquiry', 'HomeController@productinquiry')->name('product.inquiry');

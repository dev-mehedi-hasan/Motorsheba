...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // ManufacturingYear
    Route::get('/manufacturing_year', 'CompatibilityController@manufacturing_year')->name('compatibility.manufacturing_year');
    Route::post('/manufacturing_year/store', 'CompatibilityController@store_manufacturing_year')->name('compatibility.manufacturing_year.store');
    Route::get('/manufacturing_year/destroy/{id}', 'CompatibilityController@destroy_manufacturing_year')->name('compatibility.manufacturing_year.destroy');

    // Manufacturer
    Route::get('/manufacturer', 'CompatibilityController@manufacturer')->name('compatibility.manufacturer');
    Route::post('/manufacturer/store', 'CompatibilityController@store_manufacturer')->name('compatibility.manufacturer.store');
    Route::get('/manufacturer/edit/{id}', 'CompatibilityController@edit_manufacturer')->name('compatibility.manufacturer.edit');
    Route::patch('/manufacturer/update/{id}', 'CompatibilityController@update_manufacturer')->name('compatibility.manufacturer.update');
    Route::get('/manufacturer/destroy/{id}', 'CompatibilityController@destroy_manufacturer')->name('compatibility.manufacturer.destroy');

    // Car Model
    Route::get('/car_model', 'CompatibilityController@car_model')->name('compatibility.car_model');
    Route::post('/car_model/store', 'CompatibilityController@store_car_model')->name('compatibility.car_model.store');
    Route::get('/car_model/edit/{id}', 'CompatibilityController@edit_car_model')->name('compatibility.car_model.edit');
    Route::patch('/car_model/update/{id}', 'CompatibilityController@update_car_model')->name('compatibility.car_model.update');
    Route::get('/car_model/destroy/{id}', 'CompatibilityController@destroy_car_model')->name('compatibility.car_model.destroy');

    ...
    <div class="container">
        <div class="row no-gutters">
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-lg-left text-center p-4 d-block" href="{{ route('terms') }}">
                    <i class="la la-file-text la-3x text-primary mb-2"></i>
                    <h4 class="h6">{{ translate('Terms & conditions') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-lg-left text-center p-4 d-block" href="{{ route('returnpolicy') }}">
                    <i class="la la-mail-reply la-3x text-primary mb-2"></i>
                    <h4 class="h6">{{ translate('Return Policy') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-lg-left text-center p-4 d-block" href="{{ route('supportpolicy') }}">
                    <i class="la la-support la-3x text-primary mb-2"></i>
                    <h4 class="h6">{{ translate('Support Policy') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-lg-left border-lg-right text-center p-4 d-block" href="{{ route('privacypolicy') }}">
            ...
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline justify-content-md-start justify-content-center" method="POST" action="{{ route('subscribers.store') }}">
                            @csrf
                            <div class="form-group mr-sm-2 mb-0">
                                <input type="email" class="form-control text-center text-sm-left text-md-left text-lg-left text-xl-left" placeholder="{{ translate('Your Email Address') }}" name="email" required>
                            </div>
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                           <span class="d-block text-primary">{{ translate('Address') }}:</span>
                           <span class="d-block ">{{ get_setting('contact_address') }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block text-primary">{{translate('Phone')}}:</span>
                           <span class="d-block ">
                            <a href="tel:{{ get_setting('contact_phone') }}" class="text-reset">{{ get_setting('contact_phone') }}</a>
                            </span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block text-primary">{{translate('Email')}}:</span>
                           <span class="d-block ">
...
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-light">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-4 frontend-footer-copyright">
            ...
            <div class="col-md-4">
                <ul class="list-inline my-3 my-md-0 social colored text-center">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ get_setting('facebook_link') }}" target="_blank" class="facebook"><i class="lab la-facebook-f hov-text-primary"></i></a>
                    </li>
                    @endif
                    @if ( get_setting('twitter_link') !=  null )
                    <li class="list-inline-item">
                        <a href="{{ get_setting('twitter_link') }}" target="_blank" class="twitter"><i class="lab la-twitter hov-text-primary"></i></a>
                    </li>
                    @endif
                    @if ( get_setting('instagram_link') !=  null )
                    <li class="list-inline-item">
                        <a href="{{ get_setting('instagram_link') }}" target="_blank" class="instagram"><i class="lab la-instagram hov-text-primary"></i></a>
                    </li>
                    @endif
                    @if ( get_setting('youtube_link') !=  null )
                    <li class="list-inline-item">
                        <a href="{{ get_setting('youtube_link') }}" target="_blank" class="youtube"><i class="lab la-youtube hov-text-primary"></i></a>
                    </li>
                    @endif
                    @if ( get_setting('linkedin_link') !=  null )
                    <li class="list-inline-item">
                        <a href="{{ get_setting('linkedin_link') }}" target="_blank" class="linkedin"><i class="lab la-linkedin-in hov-text-primary"></i></a>
                    </li>
                    @endif
                </ul>
            </div>

    ...
    @if(!empty($array))
        ...
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 rounded">
                    ...
                    @foreach ($array as $key => $value)
                        @if ($count < 20)
                            ...
                            <div class="carousel-box">
                                <div class="row bg-white no-gutters box-3 align-items-center border border-light rounded hov-shadow-md my-2 has-transition">
                                    <div class="col-4">
                ...
                <div class="d-flex mb-3 align-items-baseline justify-content-center">
                    <a href="{{ route('sellers') }}" class="mr-0 btn btn-primary btn-sm shadow-md">{{ translate('View All Sellers') }}</a>
                </div>
            </div>
        </div>
    </section>

                ...
                @endif
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="low_stock_quantity" value="@if($product->low_stock_quantity != null){{$product->low_stock_quantity}}@else{{1}}@endif" min="0" step="1" class="form-control">
                        </div>
                    </div>
                </div>

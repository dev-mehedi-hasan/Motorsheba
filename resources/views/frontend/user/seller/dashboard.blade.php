      ...
      <div class="col-md-7">
          <div class="card py-1">
              <div class="card-header">
                ...
                <br>
                <div class="">
                    <a href="{{ route('seller.products.upload')}}" class="btn btn-primary">{{ translate('Add New Product')}}</a>
                </div>
                <div class=" mt-2"><a href="{{ route('seller.product_bulk_upload.index')}}" class="btn btn-primary">{{ translate('Bulk Product Import')}}</a>
                </div>
              </div>
          </div>
      </div>

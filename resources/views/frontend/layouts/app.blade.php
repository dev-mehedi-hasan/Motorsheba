...
<body>
    ...
    @if (get_setting('show_cookies_agreement') == 'on')
        ...
        <div class="container aiz-cookie-alert shadow-xl">

            <div class="row p-3 bg-white rounded align-items-center">

                <div class="col-lg-10 col-md-9 mb-md-0 mb-2">
                ...
                <button class="col-lg-2 col-md-3 btn btn-primary btn-sm aiz-cookie-accept">

                                            ...
                                            <div class="col-6 col-md-4">
                                                ...
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('Cards')}}</span>
                                                        </span>
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('Mobile Banking')}}</span>
                                                        </span>
                                                        <span class="aiz-square-check border-white"></span>
                                                    </span>
                                                </label>
                                            </div>
                                        @endif
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span class="d-block fw-600 fs-15">{{ translate('(COD)')}}</span>
                                                            </span>
                                                            <span class="aiz-square-check border-white"></span>
                                                        </span>
                                                    </label>

...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('All Product') }} <span class="badge badge-inline ml-2 p-3 badge-danger">{{ $products->total() }}</span></h5>
            </div>
            ...
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" id="publish_status" name="publish_status" onchange="sort_products()">
                    <option value="">{{ translate('Status') }}</option>
                    <option value="1" @if ($publish_status == "1") selected @endif>Published</option>
                    <option value="0" @if ($publish_status == "0") selected @endif>Unpublished</option>
                </select>
            </div>
            {{-- <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="type" id="type" onchange="sort_products()">
                    ...
                    <option value="unit_price,desc"@isset($col_name , $query) @if($col_name == 'unit_price' && $query == 'desc') selected @endif @endisset>{{translate('Price (High > Low)')}}</option>
                    <option value="unit_price,asc"@isset($col_name , $query) @if($col_name == 'unit_price' && $query == 'asc') selected @endif @endisset>{{translate('Price (Low > High)')}}</option>
                </select>
            </div> --}}
            <div class="col-md-2">
            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>{{translate('Categories')}}:</strong> {{ $product->category->name }} </br>

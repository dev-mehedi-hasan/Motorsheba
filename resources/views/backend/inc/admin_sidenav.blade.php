    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            <div class="px-20px mb-3">
                <input class="form-control bg-soft-secondary border-0 form-control-sm" type="text" name="" placeholder="{{ translate('Search in menu') }}" id="menu-search" onkeyup="menuSearch()">
            </div>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Compatibility')}}</span>
                                    <span class="aiz-side-nav-arrow"></span>
                                </a>
                                <ul class="aiz-side-nav-list level-3">
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('compatibility.manufacturing_year')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Manufacturing Year')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('compatibility.manufacturer')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Manufacturer')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('compatibility.car_model')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Car Model')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller_sale_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_sale_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Products Sale') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
